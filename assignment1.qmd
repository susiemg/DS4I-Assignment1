...
```{r CNN Model, warning=FALSE, message=FALSE, echo=FALSE}
max_features <- 6000      
...
kbl(data.frame(Accuracy=results[2]), caption = "CNN Model Test Accuracy") %>% kable_styling(bootstrap_options = c("hover","striped"),latex_options = "HOLD_position")
```
